        ...
        <div className='flex flex-col'>
            ...
            <div className='flex md:flex-row flex-col md:gap-[10vw] w-half md:mx-6 mx-4 md:mt-28 md:mb-16 gap-4 text-sm mt-6'>
                ...
                <div className='flex flex-col md:gap-8 gap-2'>
                    <span className='flex flex-row gap-5 items-center md:items-start'>
                        ...
                        <div className='flex flex-col gap-2'>
                            <h1 className='md:text-2xl text-base'>Hindering Mobility</h1>
                            <p className='hidden md:block text-base'>Prolonged sitting can result in muscle stiffness, reduced flexibility, and weakened strength, making it harder to rise from a seated position.</p>
                        </div>
                    </span>
                    ...
                    <span className='flex flex-row gap-4 items-center md:items-start'>
                        ...
                        <div className='flex flex-col gap-2'>
                            <h1 className='md:text-2xl text-base'>Excessive Knee Load</h1>
                            <p className='hidden md:block text-base'>Prolonged sitting can result in muscle stiffness, reduced flexibility, and weakened strength, making it harder to rise from a seated position.</p>
                        </div>
                    </span>
                    ...
                    <span className='flex flex-row gap-4 items-center md:items-start'>
                        ...
                        <div className='flex flex-col gap-2'>
                            <h1 className='md:text-2xl text-base'>Problems due to long sitting hours</h1>
                            <p className='hidden md:block text-base'>Prolonged sitting can result in muscle stiffness, reduced flexibility, and weakened strength, making it harder to rise from a seated position.</p>
                        </div>
                    </span>
                    <div className="md:flex items-start hidden">
            ...
            <div className='flex md:flex-row flex-col md:gap-[8.5vw] w-half md:mx-6 mx-4 md:my-0 gap-[3vw] text-base md:mt-4 mt-5'>
                ...
                <div className='flex flex-col gap-4 md:gap-8'>
                    ...
                    <div className='flex flex-row md:gap-10 gap-2'>
                        <div className='shadow-lg'> <Image src="/Home/home-1.png" className='' width={225} height={230} alt="logo"></Image></div>
                        <div className='shadow-lg'> <Image src="/Home/home-2.png" className='' width={225} height={230} alt="logo"></Image></div>
                        <div className='shadow-lg'> <Image src="/Home/home-3.png" className='' width={225} height={230} alt="logo"></Image></div>
                    </div>
                </div>
            </div>
        </div>
