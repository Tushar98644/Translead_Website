...
const Home = () => {
    return (
        <div className='flex flex-col'>
            ...
            <div className='flex flex-row md:gap-[15vw] w-half ml-12 md:my-40 gap-[10vw] text-sm mt-20'>
            ...
            <div className='flex flex-row md:gap-[10vw] w-half ml-12 md:my-0 gap-[10vw] text-sm mt-20'>
