...
const Footer = () => {
    return (
        <footer className="bg-gray-100 border-t shadow-lg mt-20">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between items-center flex-row gap-40">
                    ...
                    <div className="flex w-full">
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-black uppercase ">Translead Medtech Pvt Ltd,Incubated @ CPDMED TBI,MedTech & Geriatric Healthcare Technology Business Incubator @ Centre for Product Design & Manufacturing (CPDM),Raman Building,Indian Institute of Science (IISc),Bangalore-560012,Karnataka</h2>
                            <ul className="text-black font-medium">
                                <li className="mb-4">
                                    <a href="https://flowbite.com/" className="hover:underline">+91-86181 13553</a>
                                </li>
                                <li>
